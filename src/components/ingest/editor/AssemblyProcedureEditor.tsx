...
interface AssemblyProcedureEditorProps {
...
export function AssemblyProcedureEditor({
  groups,
  onAddGroup,
  onRemoveGroup,
  onRenameGroup,
  ...
  onMoveStepUp,
  onMoveStepDown,
}: AssemblyProcedureEditorProps) {
  return (
    <div className="space-y-3">
      {groups.length === 0 && (
        <p className="text-xs text-muted-foreground text-center py-4">
          No assembly steps yet. Add a group to get started.
        </p>
      )}
