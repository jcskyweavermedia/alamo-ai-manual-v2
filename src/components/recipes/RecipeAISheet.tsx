...
interface RecipeAISheetProps {
  recipe: Recipe;
  action: RecipeAIAction | null;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

export function RecipeAISheet({ recipe, action, open, onOpenChange }: RecipeAISheetProps) {
  ...
  const actionLabel = RECIPE_AI_ACTIONS.find(a => a.key === action)?.label ?? '';
