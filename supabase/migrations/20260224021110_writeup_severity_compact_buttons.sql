-- =============================================================================
-- MIGRATION: writeup_severity_compact_buttons
-- Changes severity back to radio with variant:"button" (compact pill buttons)
-- Short labels: Verbal, Written, Final, Suspension, Termination
-- =============================================================================
