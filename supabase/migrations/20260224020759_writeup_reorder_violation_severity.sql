-- =============================================================================
-- MIGRATION: writeup_reorder_violation_severity
-- Reorders so Type of Violation + Severity sit next to each other (same row)
-- Date of Incident goes full-width above them
-- Layout: Date (full) → Violation + Severity (half + half) → textareas
-- =============================================================================
