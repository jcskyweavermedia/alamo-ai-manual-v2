-- =============================================================================
-- Migration: create get_pending_actions and get_recent_insights query functions
-- Phase D helper functions for Training Manager AI tool calling
-- =============================================================================

BEGIN;

-- -----------------------------------------------------------------------------
-- Function 1: get_pending_actions
-- Returns pending training actions awaiting manager approval for a group.
-- -----------------------------------------------------------------------------
...
-- -----------------------------------------------------------------------------
-- Function 2: get_recent_insights
-- Returns non-superseded training insights for a group, ordered by severity.
-- -----------------------------------------------------------------------------
