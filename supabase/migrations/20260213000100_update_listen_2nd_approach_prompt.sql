-- Update the Listen 2nd Approach prompt with full SOS-accurate content
-- Dual-role format (Server + Guest) matching the 1st approach listen style
-- No steak knife, exactly 2 dishes, proper closing flow
...
- When the guest says no questions, ask: "May I take your order then?"
- Take both orders, confirm, and close
...
- Cuando el comensal diga que no tiene preguntas, pregunta: "¿Puedo tomar su orden entonces?"
- Toma ambas órdenes, confirma y cierra
...
- Usa los platillos y descripciones específicos mencionados arriba
