-- =============================================================================
-- MIGRATION: writeup_remove_dept_button_severity
-- Employee Write-Up form:
--   - Removes Department field
--   - Adds variant:"button" to Severity for horizontal toggle buttons
--   - Position becomes full-width (no longer paired with Department)
